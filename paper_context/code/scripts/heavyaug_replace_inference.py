"""Heavy-aug cam-adv ep60 REPLACING the original s500 cam-adv ep60.

If heavy-aug features are individually BETTER than the original cam-adv features,
this should beat 0.15884. Same recipe as 0.15884 winner, just swapping which
cam-adv ckpt is the +1 added member.
...
# 7-baseline + heavyaug (DROP original s500 cam-adv)
ALL_CKPTS = [
...
def main():
    ...
    out = '/workspace/miuam_challenge_diff/results/heavyaug_replace_baseline7_plus_ep60_submission.csv'
