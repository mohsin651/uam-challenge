"""9-ckpt ensemble: 7-baseline + cam-adv s500 ep60 + cam-adv s600 ep60.

Adds the new seed=600 cam-adv ep60 ckpt to the proven 0.15884 8-ckpt ensemble,
all at 1x equal weight (the saturation finding from §67 — cam-adv ckpts mix
safely at 1x, hurt at >1x).

Generates ONE CSV: results/camadv_s500_s600_baseline7_submission.csv.
Apply DBA(k=8) + rerank(k1=15, k2=4, λ=0.275) + class-group filter (proven recipe).
"""
import csv
import os
import numpy as np
...
CAMADV_S600_EP60 = '/workspace/miuam_challenge_diff/models/model_vitlarge_camadv_seed600/part_attention_vit_60.pth'
...
def main():
    ...
    out = '/workspace/miuam_challenge_diff/results/camadv_s500_s600_baseline7_submission.csv'
